 ...
 */
class CRM_Gmv_Upgrader_Base {

  /**
   * @var CRM_Gmv_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Gmv_Upgrader(
        'de.ekir.gmv',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Gmv_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Gmv_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
